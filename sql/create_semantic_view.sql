...
create or replace semantic view DASH_DB_SI.RETAIL.SALES_ANALYST_CICD
	...
	facts (
		MARKETING_CAMPAIGN_METRICS.CLICKS as CLICKS with synonyms=('click_throughs','selections','hits','taps','activations','click_action') comment='The total number of times users clicked on an advertisement or promotional link as part of a marketing campaign.',
